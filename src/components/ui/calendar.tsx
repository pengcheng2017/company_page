...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn("p-3 !border-none bg-white", className)}
      classNames={{
        ...
        day_selected:
          "bg-primary text-white hover:bg-primary hover:opacity-80 focus:bg-primary focus:text-white",
        day_today: "bg-white text-white-foreground",
        day_outside: "text-muted-foreground opacity-50",
        day_disabled: "text-muted-foreground opacity-50",
        day_range_middle: "aria-selected:bg-primary aria-selected:text-primary-100",
